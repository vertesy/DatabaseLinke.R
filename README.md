...
## List of Functions in DatabaseLinke.R (20) 

Updated: 2026/08/25 20:01

- #### 1 `link_pubmed()`

  Open URLs One by One. This function opens provided links sequentially with an optional delay between each.
...
- #### 4 `link_bing()`
  ...
  link_google. Parses Google search query links for a provided list of gene symbols.
